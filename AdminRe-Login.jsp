          <h2 align="left" class="style11"><span class="title"><a href="#"><span class="style27"><span class="style25">Invalid Login Details, Please Try Again!!</span>..</span></a></span></h2>
        </div> 
        <div class="span8">
		<br/>
		<form id="form1" method="post" action="Authentication.jsp?value=<%="adminlogin"%>">
          <table width="382" border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              <td width="245" height="51" align="center"><span class="style41">Admin Name (required)</span> </td>
              <td width="213"><input id="name" name="userid" class="text" /></td>
            </tr>
            <tr>
              <td height="40" align="center"><span class="style41">Password (required)</span></td>
