      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content">
            <p align="justify">		  
	   <h2 class="style10">View Logistic HashCode !!! </h2>
...
try 
{
   ...
   String Grade=request.getParameter("Logistic");
  
  
    String filename="filename.txt";
      				PrintStream p = new PrintStream(new FileOutputStream(filename));
					p.print(new String(Grade));
	...
	String query="select * from datasets where logistic_hashcode='"+h1+"' "; 
