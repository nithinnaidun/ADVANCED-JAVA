...
-->
          ...
          <div class="clr"></div>
           <%
						...
						try 
						{
						String str1 = " select distinct(logistic_hashcode) from datasets";
						Statement st1 = connection.createStatement();
						ResultSet rs1 = st1.executeQuery(str1);
						while(rs1.next())
						{
						    hsign = rs1.getString(1);
						   	String query="select * from datasets where logistic_hashcode = '"+hsign+"' "; 
...
<td  width="55" height="34" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style9 style22 style15 style1"><strong>logistic_hashcode</strong></div></td>	
         ...
         <h3 align="center">
<p align="center" class="style12"><span class="style2">Logistics Name Block Chain--->::</span> <%=s111%><br>
			    <span class="style12">Logistics Name Hash Code --->::</span><%=hsign%></p>
	     </h3>
			<div align="center">
			  <%
