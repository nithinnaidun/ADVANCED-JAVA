...
<head>
<title>A_View_damage_due_to_vibration_Results</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style24">View Damage Due to vibration Results</h2>
          
            <table width="200" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td><iframe width="850" height="500" src="Results2.jsp"></iframe></td>
              </tr>
            </table>
            <p>&nbsp;</p>
